...
global.Interface = document.querySelector("#UI");
global.ctx = global.canvas.getContext("2d");
global.ctx.imageSmoothingEnabled = false;
global.userInterface = global.Interface.getContext("2d");
global.prevTotalRunningTime = 0;
global.deltaTime = 0;
global.allGameObjects = [];
global.playerObject = {};
global.backgroundShift = 0;
global.backgroundMaxShift = -6000;
global.gravityForce = 9.81;
global.pixelToMeter = 100;
global.bulletArray = [];
global.allGameObjects.push(global.bulletArray)
